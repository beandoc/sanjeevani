...
export function ClinicalSafetyAssessmentPanel({ patient, onChange }: Props) {
  ...
  const set = (key: keyof NonNullable<PatientDependenceProfile['clinicalAssessments']>, value: any) => onChange({ ...patient, clinicalAssessments: { ...assessments, [key]: value } });
