      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            side={side}
          >
            <SheetTitle className="sr-only">Eldercare Pro Navigation</SheetTitle>
        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ? (open ? "w-[--sidebar-width]" : "w-[calc(var(--sidebar-width-icon)_+_theme(spacing.4))]")
              : (open ? "w-[--sidebar-width]" : "w-[--sidebar-width-icon]")
          )}
        />
        <div
          className={cn(
            "duration-300 fixed inset-y-0 z-30 hidden h-svh transition-[left,right,width,box-shadow] ease-in-out md:flex",
            side === "left"
