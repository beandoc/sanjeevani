...
export default function ClinicianError({
  ...
  useEffect(() => {
    console.error('Clinician Module Error Boundary caught:', error);
  }, [error]);
    ...
    <div className="min-h-[50vh] flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center space-y-6 bg-card border border-border/80 p-6 rounded-2xl shadow-sm">
        ...
        <div className="space-y-2">
          <h2 className="text-xl font-bold font-headline">Clinician Module Load Error</h2>
          <p className="text-xs text-muted-foreground leading-relaxed">
            The requested clinical module encountered a momentary rendering issue during hot-reloading.
          </p>
          {error?.message && (
