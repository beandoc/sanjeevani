...
const MODULE_ID = 'nutrition-care-professional';
const SECTIONS = 4;
      ...
      <Accordion type="single" collapsible className="w-full" defaultValue="item-1">
        <AccordionItem value="item-1">
          ...
          <AccordionContent className="pt-2 space-y-4">
            <SectionCard
              sectionId={1}
              title="Etiology of Geriatric Malnutrition"
        ...
        <AccordionItem value="item-2">
          ...
          <AccordionContent className="pt-2 space-y-4">
            ...
            >
                 ...
                 <h4 className="font-semibold mt-4">Diagnostic Criteria</h4>
        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent className="pt-2 space-y-4">
             <SectionCard
              sectionId={3}
              title="Interpreting Lab Markers"
              onComplete={handleSectionComplete}
