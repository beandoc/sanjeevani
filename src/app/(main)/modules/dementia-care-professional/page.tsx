...
import { ArrowLeft, Stethoscope, Brain, Shield, Activity, Microscope } from 'lucide-react';
...
export default function DeliriumProfessionalPage() {
  ...
  const t = useTranslations('Modules.dementia-care-professional');
      ...
      <Accordion type="single" collapsible className="w-full" defaultValue="item-1">
        <AccordionItem value="item-1">
          ...
          <AccordionContent className="pt-2 space-y-4">
            ...
            >
              ...
              <h4 className="font-semibold mt-4">{t('sections.item-1.content.h4_1')}</h4>
        ...
        <AccordionItem value="item-2">
          ...
          <AccordionContent className="pt-2 space-y-4">
            ...
            >
              ...
              <p>{t('sections.item-2.content.p2')}</p>
            </SectionCard>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-4">
          ...
          <AccordionContent className="pt-2 space-y-4">
            ...
            >
              ...
              <h4 className="font-semibold mt-2">{t('sections.item-4.content.h4_1')}</h4>
              ...
              <h4 className="font-semibold mt-4">{t('sections.item-4.content.h4_2')}</h4>
              <ul className="list-disc pl-5 space-y-2">
        ...
        <AccordionItem value="item-5">
          ...
          <AccordionContent className="pt-2 space-y-4">
            ...
            >
              <h4 className="font-semibold">{t('sections.item-5.content.h4_1')}</h4>
              <p>{t('sections.item-5.content.p1')}</p>
              <h4 className="font-semibold mt-4">{t('sections.item-5.content.h4_2')}</h4>
              <p className="font-semibold">{t('sections.item-5.content.p2')}</p>
